...
GMAIL_USERNAME = 'avneetsaggu01@gmail.com' #change this to match your gmail account
GMAIL_PASSWORD = 'saggu1234'  #change this to match your gmail password
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if (confidence < 100):
            ...
            confidence = "  {0}%".format(round(100 - confidence))
            r= requests.post('https://maker.ifttt.com/trigger/DETECT/with/key/dmOJvcQyMfI3pSU-cNBvv0')
            htmlfile = urllib2.urlopen("https://avneetproje.000webhostapp.com/buttonStatus.php")
